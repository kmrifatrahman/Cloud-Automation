...
param (
    ...
    [Parameter(Mandatory = $false)][string]$cseURI = 'https://github.com/kmrifatrahman1/PowerShell-Scripts/blob/master/ImageAndSnap/Create_snapshot_of_vm/SysprepCSE.ps1',
