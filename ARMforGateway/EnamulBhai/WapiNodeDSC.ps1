...
configuration VMConfiguration
{
    ...
    node "wapi"
    {
        ...
        $userPassword1 = Get-AzKeyVaultSecret -VaultName 'testhuluKV' -Name 'passwd1' -AsPlainText
        ...
        $userPassword2 = Get-AzKeyVaultSecret -VaultName 'testhuluKV' -Name 'passwd2' -AsPlainText
